...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_NATURAL_CURE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_WIND_RIDER, ABILITY_EFFECT_SPORE },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_NATURAL_CURE },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_NONE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TRACE, ABILITY_HYPER_CUTTER },
    #else
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TRACE, ABILITY_HYPER_CUTTER },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_NONE, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_NONE, ABILITY_IMMUNITY  },
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_NONE, ABILITY_IMMUNITY  },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_NONE, ABILITY_INSOMNIA },
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_GUTS, ABILITY_HUGE_POWER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_MAGNET_PULL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_OBLIVIOUS },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_OBLIVIOUS },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_SHADOW_TAG },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_SHADOW_TAG },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_INTIMIDATE, ABILITY_ROCK_HEAD },
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PURE_POWER, ABILITY_NONE, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_TINTED_LENS, ABILITY_NONE },
    #else
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_POISON_POINT, ABILITY_OVERGROWTH },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Budew"),
        .cryId = CRY_BUDEW,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_NONE, ABILITY_WHITE_SMOKE },
    #else
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_NONE, ABILITY_WHITE_SMOKE },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_OWN_TEMPO, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_BLACK,
